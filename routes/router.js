  ...
  console.log("1");
    ...
    if(product.stock< 10){
      ...
      const transporter = await nodemailer.createTransport({
        ...
        port: 587,
        auth: {
            user: 'ayushrai803@gmail.com',
            pass: 'nxfl pzjp rwpu brkg'
        },
    });
...
const mailOptions = {
    ...
    <p>The stock of product with product id  <strong>${productId}</strong> is successfully updated </p>
...
const genAI = new GoogleGenerativeAI('AIzaSyCbjK5vyZwzUkj6kXyW3cNBEivf20Pows4');
